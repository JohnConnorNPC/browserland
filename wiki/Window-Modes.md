...
- **Control Panel → Windows → Window mode.** Open the [[Control Panel|Getting-Started]] (right-click the + button and choose **Control panel**, or the desktop → **🎛 Control panel**, or press `Ctrl+Alt+p`), then pick the window mode.
