...
All shortcuts are user-rebindable in **Control Panel → Input → Keybindings**. Open the [[Control Panel|Getting-Started]] (right-click the + button or the desktop → **🎛 Control panel**, or press `Ctrl+Alt+p`), find the action you want, and record a new combo for it.
