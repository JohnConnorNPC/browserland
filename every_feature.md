...
- [ ] [F021] Single active-browser lease — exactly one browser is the layout writer; "Become active" takeover prompt; terminals keep running regardless (webterm/broker/app.py, index.html)
